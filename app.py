...
if lang == "English":
    ...
    wind_dir_map = {
        'উত্তর (০)': 0, 'উত্তর-উত্তর-পূর্ব (১)': 1, 'উত্তর-পূর্ব (২)': 2, 'পূর্ব-উত্তর-পূর্ব (৩)': 3,
        'পূর্ব (৪)': 4, 'পূর্ব-দক্ষিণ-পূর্ব (৫)': 5, 'দক্ষিণ-পূর্ব (৬)': 6, 'দক্ষিণ-দক্ষিণ-পূর্ব (৭)': 7,
        'দক্ষিণ (৮)': 8, 'দক্ষিণ-দক্ষিণ-পশ্চিম (৯)': 9, 'দক্ষিণ-পশ্চিম (১০)': 10, 'পশ্চিম-দক্ষিণ-পশ্চিম (১১)': 11,
        'পশ্চিম (১২)': 12, 'পশ্চিম-উত্তর-পশ্চিম (১৩)': 13, 'উত্তর-পশ্চিম (১৪)': 14, 'উত্তর-উত্তর-পশ্চিম (১৫)': 15
    }
